        ...
        >
          <div className="flex flex-col justify-center">
            ...
            <p className="subtitle max-w-[400px]">
              Pronto para tirar suas ideias do papel? Seja um projeto, uma
              parceria ou só um oi, envie sua mensagem e vamos começar essa
              jornada juntos!
            </p>
          </div>
          <div
        ...
        <div className="grid xl:grid-cols-2 mb-24 xl:mb-32">
          ...
          >
            <div className="flex items-center gap-x-8">
              ...
              <div>igorbragafarias@gmail.com</div>
            </div>
            <div className="flex items-center gap-x-8">
              <RiHomeFill size={18} className="text-primary" />
              <div>Nova Iguaçu, Rio de janeiro, Brasil</div>
            </div>
          </div>
          <Form />
        </div>
